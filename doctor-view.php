...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-12">
				<h1 class="m-0 text-dark">View Doctor</h1>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-md-12">
					...
					style="display: flex;
						...
						<div class="card-tools" style="flex:0.9">
							<div class="input-group input-group-sm" style="width: 350px;">
								<input type="text" name="table_search" class="form-control" placeholder="Search by Doctor Name" id="dy-search" onkeyup="dySearch()">
		                ...
		                <h3 class="card-title" style="flex:0.1">
							<a href="?page=add-doctor" class="btn btn-info">Add New</a>
						</h3>
		           </div>
       		...
       		<tbody id="load-record">
       			<?php 
       			$getDoctor = new RecordSet('SELECT id, name, username, email, phone_no, status FROM `doctor` ORDER BY ID DESC LIMIT 7 ');
       			if($getDoctor->totalRows > 0 ){
       				while($rowData = $getDoctor->result->fetch_assoc()){ ?>
       					<tr>
							...
							<td><a href="<?php echo LOCAL_HOME_URL.'?page=add-doctor&id='.$rowData["id"];?>">
