					...
					style="display: flex;
						...
						<div class="card-tools" style="flex:0.9">
							<div class="input-group input-group-sm" style="width: 350px;">
								<input type="text" name="table_search" class="form-control" placeholder="Search by Staff Name" id="dy-search" onkeyup="dySearch()">
		                ...
		                <h3 class="card-title" style="flex:0.1">
							<a href="?page=add-staff" class="btn btn-info">Add New</a>
						</h3>
		           </div>
